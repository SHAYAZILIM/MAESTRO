...
namespace AVPMetre.UserControls
{
    public partial class ucIsKayitUfak : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        //                        //hatirlatma.BITIS_TARIHI = myIs.ONGORULEN_BITIS_TARIHI.Value;
        //                        //hatirlatma.ACIKLAMA = "mail hatırlatma";
        //                        //hatirlatma.HATIRLATMA_TIPI = "1";
        //                        //hatirlatma.BASLANGIC_ID = 1;
        //                        //hatirlatma.PERIYOD_ID = 1;

        //                        #region Mail ile iş bildir
        ...
        //                        #region Mail ile yapilmamişsa bildir
        ...
        //                        #endregion Mail ile yapilmamişsa bildir

        //                        #region Mail ile hatırlatma bildir
        ...
        //                        #endregion Mail ile hatırlatma bildir
        //                    }
        ...
        //    // Kaydetmeden önce boş alan kontrolü.
        ...
        //    //proje,dosya no bilgilerinin getirilmesi ve durum checkEdit'inin false gelmesi sağlandı
        ...
        //        //c_lueKategori.Text = "DİĞER";
        //        //c_lueOncelik.Text = "ACİL";
        //        //c_lueDurum.Text = "MEŞGUL";
        //        //c_lueEtiket.Text = "ÖNEMLİ";
        ...
        //            strBuilder.AppendLine("Yapılcak iş giriniz");
        //        if (d.YER == null)
        //            strBuilder.AppendLine("Yer giriniz");
        //        if (d.AV001_TDI_BIL_IS_TARAFCollection.Count == 0)
        //            strBuilder.AppendLine("Tarafları giriniz");
        //    }
        ...
        //        {
        //            isim.KATEGORI_ID =
        //               (c_lueKategori.Properties.GetDataSourceRowByDisplayValue("DİĞER") as
        ...
        //            isim.STATU_ID =
        //                (c_lueDurum.Properties.GetDataSourceRowByDisplayValue("BOŞ") as
        //                 AvukatProLib2.Entities.per_TDI_KOD_IS_DURUM).ID;

        //            isim.ETIKET_ID =
        //                (c_lueEtiket.Properties.GetDataSourceRowByDisplayValue("İŞ") as
        ...
        //        //Durum CheckEditinin açılışta False gelmesi sağlandı
        //        isim.DURUM = false;
        ...
        //            // Etiket,durum,oncelik ve kategori default değerleri
        ...
        //    // Combolardan gelen değer eğer seçilmemiş ise 0 gelmekte ve modul ve forma bu id ile kaydetmeye
        //    // çalışıyor ve hata alıyordu. aşağıdaki kodlar ile eğer deperler soforsa null yaparak hata engellendi.
        //    int kayitSayisi = 0;
        //    TList<AV001_TDI_BIL_IS> ds = (TList<AV001_TDI_BIL_IS>)this._bndIs.DataSource;
        //    foreach (AV001_TDI_BIL_IS d in ds)
        //    {
        ...
        //        //işin taraflarının NN_IS_CARI tablosuna kaydedilmesi.
        ...
        //        // Proje Seçilmişse o proje NN tAblıoya Ekleniyor
        ...
        //        //yapılan iş kaydının ilgili nn tablosuna kaydı.
        ...
        ////form güncelleme modunda açılırken dosya no bilgisinin gelmesi için eklendi.
        ...
        ////form güncelleme modunda açılırken proje bilgisinin gelmesi için eklendi.
        ...
        //        //Klasör ekranından iş kaydı yapılmak istendiğinde seçili klasörün kayıt ekranında default gelmesi eklendi.
        //        if (KlasorID != -1)
        //        {
