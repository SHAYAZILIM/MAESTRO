...
{
    public partial class ucForm163_52 : AdimAdimDavaKaydi.Util.BaseClasses.AvpXUserControl// UserControl
    {
        public ucForm163_52()
        {
            InitializeComponent();
        ...
        //{
        //    foreach (Control c in pn163_52.Controls)
        //    {
        //        if (c is TextEdit)
        ...
        private void FormHazirla(ChangingEventArgs e)
        {
            ...
            if (e.NewValue != null)
            {
                if ((int)e.NewValue == 35 || (int)e.NewValue == 33)
                {
                ...
                else if ((int)e.NewValue != 35 || (int)e.NewValue == 33)
                {
                    ...
                    //lblCekKom.Enabled = false;
                    //CekTazKomisyonu.Enabled = false;
                    CekKomisyonu.Value = Convert.ToDecimal(0);
                    CekTazKomisyonu.Value = Convert.ToDecimal(0);
                }
                ...
                switch (f)
                {
                    case FormTipleri.Form163:
                        ...
                        {
                            if (var.ALACAK_NEDENI == "DÝÐER ALACAK...")
                            {
                                ned.Remove(var);
        ...
        private void ucForm163_52_Load(object sender, EventArgs e)
        {
            labelControl1.Enabled = false;
            txtDigerAlacak.Enabled = false;
            ToFaizOran.Enabled = false;
