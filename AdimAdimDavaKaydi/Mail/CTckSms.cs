...
{
    internal class CTckSms
    {
        public string sendTckSms(string token, string tcknos, string templateText, string originatorId, string isUTF8Allowed, string validityPeriod)
        {
            WebRequest request = WebRequest.Create("http://live.iletisimmakinesi.com:9080/TcksmsGatewayWS/functions/sendTCKSMS");

            request.Method = "POST";
            string postData;
            postData = "token=" + token + "&tcknos=" + tcknos + "&templateText=" + templateText + "&originatorId=" + originatorId + "&isUTF8Allowed=" + isUTF8Allowed + "&validityPeriod=" + validityPeriod;
