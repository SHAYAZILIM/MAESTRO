...
{
    public class rSerbestMeslekMakbuzsuzDavaDosyalari
    {
        #region Settings
        ...
        public GridColumn[] GetGridColumns()
        {
            ...
            colKONTROL_KIM_ID.VisibleIndex = 35;
        ...
        public PivotGridField[] GetPivotFields()
        {
            ...
            fieldKONTROL_KIM_ID.AreaIndex = 35;
        ...
        private Dictionary<string, string> GetCaptionDictinory()
        {
            ...
            dicFieldCaption.Add("Referans1", "Ref1");
            dicFieldCaption.Add("Referans2", "Ref2");
            dicFieldCaption.Add("Referans3", "Ref3");
