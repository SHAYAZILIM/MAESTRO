...
namespace AvukatProRaporlar.Raport.Util
{
    ...
    public class ExtendedGridControl : GridControl
    {
        ...
        public void btnSaveLayout_ItemClick(object sender, ItemClickEventArgs e)
        {
            GorunumuKaydet();
        }

        public void GorunumuKaydet()
        {
            try
            {
                List<Bilgi> Lbilgi = StilOku();
                string _path = Application.StartupPath + "\\layouts\\" + KullaniciAdi + "\\";
                ...
                {
                    string filePath = _path + _UniqueId + ".yyl";
                    view.SaveLayoutToXml(filePath, OptionsLayoutBase.FullLayout);

                    //m.s
                    string stylePath = _path + _UniqueId + ".yyss";
                    ...
                    if (view is GridView)
                    {
                        ...
                        {
                            foreach (Bilgi bg in Lbilgi)
                            {
                                if (!ayarim.StyleConditions.Contains(bg))
                                {
                                    ayarim.StyleConditions.Add(bg);
                                }
                            }
                        }
                    }
                    ...
                    bf.Serialize(File.Create(stylePath), ayarim);
                ...
                if (Directory.Exists(_path))
                {
                    foreach (BaseView view in this.ViewCollection)
                    {
                        ...
                        if (File.Exists(stylePath))
                        {
                            ...
                            //m.s
                            BinaryFormatter bf = new BinaryFormatter();
                            GridAyar ayar = bf.Deserialize(File.Open(stylePath, FileMode.Open)) as GridAyar;
        ...
        public List<Bilgi> StilOku()
        {
            BinaryFormatter bf = new BinaryFormatter();
            string path = Application.StartupPath + "\\StyleConditions\\" + _UniqueId + "_" + ".scxx";
            if (File.Exists(path))
            {
                var obj = bf.Deserialize(File.Open(path, FileMode.Open));
                return obj as List<Bilgi>;
            }
            else
                return new List<Bilgi>();
        }
        ...
        private void barButtonItem1_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (this.MainView is GridView)
            {
                ...
                frm.GBilgi = gridbilgi;
                frm.uniqueID = _UniqueId;
                frm.ShowDialog();
            }
            else
            {
        ...
        private void barButtonItem2_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                GridControl gc = Cast<GridControl>.It(Cast<ControlNavigator>.It(this).NavigatableControl);
        ...
        private void btnGonder1_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            //rc.ApplicationIcon = Resource1.avukatpro7_40x40;
        ...
        private void ExportIt(int index)
        {
            try
            {
                ...
                if (sv.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        DialogResult sonuc = XtraMessageBox.Show("Ýliþkili Tablo KAyýtlarý Gösterilsin mi?", "Detaylar Gösterilsin mi", MessageBoxButtons.YesNo);
        ...
        /// <summary>
        /// Satir numaralarýný GHosteren Event tir . Burada Ýndicator draw olacaktýr ve her satýr
        /// için Draw iþleminde o satýrýn numarasý yazýlacaktýr.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void ExtendedGridControl_ShowGridMenu(object sender, GridMenuEventArgs e)
        {
            if (e.MenuType == DevExpress.XtraGrid.Views.Grid.GridMenuType.Column)
            {
                ...
                if (menu.Column != null)
                {
                    //TODO:Resource1 dan string olarak çek
                    ...
                    menu.Items.Add(CreateCheckItem("Saða Kilitle", menu.Column, FixedStyle.Right, null));
        ...
        public static ImageList MyImageList
        {
            get
            {
                if (_MyImageList == null)
                {
                    ...
                    int index = imgList.Images.Add(Resource1.dnext_12x12_getir, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Getir, index);

                    //int index2 = imgList.Images.Add(Resource1.dnext_12x12_cevir, Color.Transparent);
                    //MyImageIndexes.Add(NavImages.Cevir, index2);
                    int index3 = imgList.Images.Add(Resource1.dnext_12x12_fscreen, Color.Transparent);
                    MyImageIndexes.Add(NavImages.TamEkran, index3);
                    int index4 = imgList.Images.Add(Resource1.dnext_12x12_printer, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Yazdir, index4);
                    int index5 = imgList.Images.Add(Resource1.dnext_12x12_excel, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Export, index5);
                    int index6 = imgList.Images.Add(Resource1.dnext_12x12_email, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Email, index6);
                    int index7 = imgList.Images.Add(Resource1.dnext_12x12_add, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Ekle, index7);
                    int index8 = imgList.Images.Add(Resource1.dnext_12x12_tick, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Tamamla, index8);
                    int index9 = imgList.Images.Add(Resource1.dnext_12x12_next, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Ileri, index9);
                    int index10 = imgList.Images.Add(Resource1.dnext_12x12_previous, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Geri, index10);
                    int index11 = imgList.Images.Add(Resource1.dnext_12x12_last, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Son, index11);
                    int index12 = imgList.Images.Add(Resource1.dnext_12x12_first, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Ilk, index12);
                    int index122 = imgList.Images.Add(Resource1.dnext_12x12_delete, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Sil, index122);
                    int index13 = imgList.Images.Add(Resource1.dnext_12x12_editor, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Editor, index13);
                    int index14 = imgList.Images.Add(Resource1.favorite_22x22, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Kisisellestir, index14);
                    int index15 = imgList.Images.Add(Resource1.html, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Html, index15);
                    int index16 = imgList.Images.Add(Resource1.doc, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Doc, index16);
                    int index17 = imgList.Images.Add(Resource1.pdf, Color.Transparent);
                    MyImageIndexes.Add(NavImages.Pdf, index17);
                    _MyImageList = imgList;
                    int index18 = imgList.Images.Add(Resource1.sihirbaz1_16x16, Color.Transparent);
